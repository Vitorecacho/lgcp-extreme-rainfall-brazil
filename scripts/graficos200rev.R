...
load("/dados/extremerain/modeloextremerain200intercept.Rdata")
...
p_count <- ggplot(mcount, aes(x = time, y = count)) +
  ...
  labs(
    title = "Monthly occurrence counts - 200mm"
  )
...
# salvar
ggsave(
  "monthly_occurrence_counts_200.png",
  p_count,
  dpi = 600,
  width = 8,
  height = 3.5
