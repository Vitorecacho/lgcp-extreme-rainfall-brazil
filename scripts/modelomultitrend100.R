...
Si=rep(mesh_regions=="Sul",542)
Ni=rep(mesh_regions=="Norte",542)
NEi=rep(mesh_regions=="Nordeste",542)
SEi=rep(mesh_regions=="Sudeste",542)
COi=rep(mesh_regions=="Centro Oeste",542)
...
save.image("modeloextremerain100interceptMulti.Rdata")							 
